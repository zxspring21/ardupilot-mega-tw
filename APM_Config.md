There are many configuration options that you can set in the ArduPlane APM\_Config.h file. Just add any of these `#define` lines to the APM\_Config.h file to use it, then compile and [load the software with Arduino](http://code.google.com/p/ardupilot-mega/wiki/Code).

Here is a list of all them, with instructions:
